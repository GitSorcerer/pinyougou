...
/*        if(specification!=null){
            System.out.println("specification不为空！");
            System.out.println("TbSpecification:"+specification.getSpecification());
            List<TbSpecificationOption> tbSpecificationOptionList = specification.getSpecificationOptionList();
            System.out.println("SpecificationOptionList:"+tbSpecificationOptionList.size());
